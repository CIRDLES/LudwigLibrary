...
public class BigDecimalCustomAlgorithms {
    ...
    /**
     * Returns the square root of a BigDecimal object. Uses the Babylonian
     * method. Uses a precision of 34 digits (the same as
     * MathContext.DECIMAL128). Iterates until further iterations of the
     * algorithm don't update the estimate any further, i.e. iterates until the
    ...
    /**
     * Returns the square root of a BigDecimal object. Uses the Babylonian
     * method. Uses a precision given by a parameter Iterates until further
     * iterations of the algorithm don't update the estimate any further, i.e.
     * iterates until the best guess for the given precision is achieved.
     *
     * @param S The number of which the square root is returned
     * @param precision The number of digits the return value will be.
     * Calculating less digits is faster.
     * @return The square root of S
     * @throws NumberFormatException if S is negative
     */
    ...
    /**
     * Obtains an initial guess for the square root of a BigDecimal number. If
     * the number is too small/too large to be represented as a double,
     * 10^(n/2), where n is the number of digits left of the decimal place of S,
     * is used. Otherwise, the square root of the double value is used.
     *
     * @param S
